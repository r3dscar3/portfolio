...
async function convertDataStrategyResultToDataResult2(dataStrategyResult) {
  ...
  if (type === ResultType2.error) {
    if (isDataWithResponseInit2(result)) {
      ...
      result = new ErrorResponseImpl2(((_result$init2 = result.init) == null ? void 0 : _result$init2.status) || 500, void 0, result.data);
    }
    return {
      type: ResultType2.error,
      error: result,
...
async function convertDataStrategyResultToDataResult3(dataStrategyResult) {
  ...
  if (type === ResultType3.error) {
    if (isDataWithResponseInit3(result)) {
      ...
      result = new ErrorResponseImpl3(((_result$init2 = result.init) == null ? void 0 : _result$init2.status) || 500, void 0, result.data);
    }
    return {
      type: ResultType3.error,
      error: result,
...
function unwrapSingleFetchResult(result, routeId) {
  if ("error" in result) {
    ...
    return redirect5(result.redirect, {
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-LYIRLHRM.js.map
