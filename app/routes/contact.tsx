      ...
      <div className="space-y-10">
        <div className="space-y-4 mt-4">
          <p className="text-title3 italic">
            Have a question, idea, or just want to connect? I'd love to hear
            from you! Whether it's about a job opening, a collaboration
            opportunity, or a quick chat about tech and development, I'm just a
            message away.
          </p>
          <p>
