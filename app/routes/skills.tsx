      ...
      <div className='space-y-10'>
        <div className='space-y-4 mt-4'>
          <p className='px-2 text-title3 italic'>
            As a Staff Engineer, my role is about more than just writing great code—it's about
            driving impact at scale through technical leadership, strategic thinking, and
            collaboration. Over the years, I've honed a set of core skills that enable me to deliver
            robust solutions, guide teams, and align technology with business goals.
          </p>

          <p className='px-2'>
            This page highlights the areas I focus on as a Staff Engineer, showcasing my approach to
            solving complex challenges, fostering innovation, and empowering teams to excel.
          </p>
        </div>
