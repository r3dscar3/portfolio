        ...
        <div>
          ...
          <div className='px-2'>
            <div className='space-y-4 mb-6'>
              <WorkItem company='Fliff' title='Staff software Engineer' dates='2024 - 2026' />

              <WorkItem company='Mojo' title='Staff software Engineer' dates='2021 - 2024' />
              ...
              <WorkItem company='NHL' title='Application Developer' dates='2017 - 2019' />
            </div>
          </div>
        </div>
      </div>
